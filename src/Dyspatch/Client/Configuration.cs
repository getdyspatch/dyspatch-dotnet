...
namespace Dyspatch.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration(
            ...
            string basePath = "https://api.dyspatch.io") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/5.0.0/csharp"
        ...
        {
            String report = "C# SDK (Dyspatch) Debug Report:\n";
            report += "    OS: " + System.Runtime.InteropServices.RuntimeInformation.OSDescription + "\n";
            report += "    Version of the API: 2020.04\n";
