...
namespace Dyspatch.Api
{
    ...
    public partial class LocalizationsApi : ILocalizationsApi
    {
        ...
        /// <returns></returns>
        public LocalizationsApi(Dyspatch.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<LocalizationRead> localVarResponse = GetLocalizationByIdWithHttpInfo(localizationId, targetLanguage, accept);
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2020.04\&quot;, set the value to \&quot;application/vnd.dyspatch.2020.04+json\&quot;</param>
        /// <returns>ApiResponse of LocalizationRead</returns>
        public ApiResponse<LocalizationRead> GetLocalizationByIdWithHttpInfo (string localizationId, string targetLanguage, string accept)
        {
            // verify the required parameter 'localizationId' is set
            if (localizationId == null)
                throw new ApiException(400, "Missing required parameter 'localizationId' when calling LocalizationsApi->GetLocalizationById");
            // verify the required parameter 'targetLanguage' is set
            if (targetLanguage == null)
                throw new ApiException(400, "Missing required parameter 'targetLanguage' when calling LocalizationsApi->GetLocalizationById");
            // verify the required parameter 'accept' is set
            if (accept == null)
                throw new ApiException(400, "Missing required parameter 'accept' when calling LocalizationsApi->GetLocalizationById");
            ...
            {
                Exception exception = ExceptionFactory("GetLocalizationById", localVarResponse);
