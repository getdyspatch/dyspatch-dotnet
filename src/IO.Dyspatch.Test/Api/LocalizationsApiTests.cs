...
namespace IO.Dyspatch.Test
{
    ...
    public class LocalizationsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GetDraftLocalizationById
        /// </summary>
        [Fact]
        public void GetDraftLocalizationByIdTest()
        {
            ...
            //string accept = null;
            //var response = instance.GetDraftLocalizationById(draftId, localizationId, targetLanguage, accept);
            //Assert.IsType<LocalizationRead> (response, "response is LocalizationRead");
        }
        
        /// <summary>
        /// Test GetPublishedLocalizationById
        /// </summary>
        [Fact]
        public void GetPublishedLocalizationByIdTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string localizationId = null;
            //string targetLanguage = null;
            //string accept = null;
            //var response = instance.GetPublishedLocalizationById(localizationId, targetLanguage, accept);
            //Assert.IsType<LocalizationRead> (response, "response is LocalizationRead");
        }
