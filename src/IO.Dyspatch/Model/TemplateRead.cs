...
namespace IO.Dyspatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateRead :  IEquatable<TemplateRead>
    {
        /// <summary>
        ...
        public TemplateRead(string id = default(string), string name = default(string), string description = default(string), string url = default(string), CompiledRead compiled = default(CompiledRead), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?), List<LocalizationMetaRead> localizations = default(List<LocalizationMetaRead>))
        {
            this.Id = id;
            this.Name = name;
