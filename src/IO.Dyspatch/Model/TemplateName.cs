...
namespace IO.Dyspatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateName :  IEquatable<TemplateName>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateName" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TemplateName);
        }

        /// <summary>
        /// Returns true if TemplateName instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateName input)
        {
            if (input == null)
                return false;
