...
namespace IO.Dyspatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LanguageId :  IEquatable<LanguageId>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as LanguageId);
        }

        /// <summary>
        /// Returns true if LanguageId instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageId input)
        {
            if (input == null)
                return false;
