...
namespace IO.Dyspatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateId :  IEquatable<TemplateId>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TemplateId);
        }

        /// <summary>
        /// Returns true if TemplateId instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateId input)
        {
            if (input == null)
                return false;
