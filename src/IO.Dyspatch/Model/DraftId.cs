...
namespace IO.Dyspatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DraftId :  IEquatable<DraftId>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DraftId" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DraftId);
        }

        /// <summary>
        /// Returns true if DraftId instances are equal
        /// </summary>
        /// <param name="input">Instance of DraftId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DraftId input)
        {
            if (input == null)
                return false;
