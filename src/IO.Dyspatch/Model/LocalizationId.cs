...
namespace IO.Dyspatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocalizationId :  IEquatable<LocalizationId>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocalizationId" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocalizationId {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LocalizationId);
        }

        /// <summary>
        /// Returns true if LocalizationId instances are equal
        /// </summary>
        /// <param name="input">Instance of LocalizationId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocalizationId input)
        {
            if (input == null)
                return false;
