...
namespace IO.Dyspatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateUrl :  IEquatable<TemplateUrl>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateUrl" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TemplateUrl);
        }

        /// <summary>
        /// Returns true if TemplateUrl instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateUrl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateUrl input)
        {
            if (input == null)
                return false;
