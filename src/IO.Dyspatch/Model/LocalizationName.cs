...
namespace IO.Dyspatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocalizationName :  IEquatable<LocalizationName>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocalizationName" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocalizationName {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LocalizationName);
        }

        /// <summary>
        /// Returns true if LocalizationName instances are equal
        /// </summary>
        /// <param name="input">Instance of LocalizationName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocalizationName input)
        {
            if (input == null)
                return false;
