...
namespace IO.Dyspatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompiledRead :  IEquatable<CompiledRead>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ampHtml">Base64 encoded amp version of template body.</param>
        /// <param name="text">Base64 encoded template text body.</param>
        public CompiledRead(string sender = default(string), string replyTo = default(string), byte[] subject = default(byte[]), byte[] html = default(byte[]), byte[] ampHtml = default(byte[]), byte[] text = default(byte[]))
        {
            this.Sender = sender;
        ...
        /// </summary>
        /// <value>Base64 encoded amp version of template body</value>
        [DataMember(Name="ampHtml", EmitDefaultValue=false)]
        public byte[] AmpHtml { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AmpHtml: ").Append(AmpHtml).Append("\n");
        ...
        public bool Equals(CompiledRead input)
        {
            ...
            return 
                ...
                (
                    this.AmpHtml == input.AmpHtml ||
                    (this.AmpHtml != null &&
                    this.AmpHtml.Equals(input.AmpHtml))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AmpHtml != null)
                    hashCode = hashCode * 59 + this.AmpHtml.GetHashCode();
                if (this.Text != null)
