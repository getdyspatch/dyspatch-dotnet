...
namespace IO.Dyspatch.Api
{
    ...
    public interface ITemplatesApi : IApiAccessor
    {
        ...
        ApiResponse<TemplatesRead> TemplatesGetWithHttpInfo (string cursor = null);
        /// <summary>
        /// Get Template by ID
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<TemplateRead> TemplatesTemplateIdGetWithHttpInfo (string templateId, string targetLanguage);
        ...
        System.Threading.Tasks.Task<TemplatesRead> TemplatesGetAsync (string cursor = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<TemplatesRead>> TemplatesGetAsyncWithHttpInfo (string cursor = null);
        /// <summary>
        /// Get Template by ID
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<TemplateRead> TemplatesTemplateIdGetAsync (string templateId, string targetLanguage);
        ...
        System.Threading.Tasks.Task<ApiResponse<TemplateRead>> TemplatesTemplateIdGetAsyncWithHttpInfo (string templateId, string targetLanguage);
    ...
    public partial class TemplatesApi : ITemplatesApi
    {
        ...
        /// <param name="cursor">A cursor value used to retrieve a specific page from a paginated result set. (optional)</param>
        /// <returns>TemplatesRead</returns>
        public TemplatesRead TemplatesGet (string cursor = null)
        {
             ApiResponse<TemplatesRead> localVarResponse = TemplatesGetWithHttpInfo(cursor);
        ...
        /// <param name="cursor">A cursor value used to retrieve a specific page from a paginated result set. (optional)</param>
        /// <returns>ApiResponse of TemplatesRead</returns>
        public ApiResponse< TemplatesRead > TemplatesGetWithHttpInfo (string cursor = null)
        {
        ...
        /// <param name="cursor">A cursor value used to retrieve a specific page from a paginated result set. (optional)</param>
        /// <returns>Task of TemplatesRead</returns>
        public async System.Threading.Tasks.Task<TemplatesRead> TemplatesGetAsync (string cursor = null)
        {
             ApiResponse<TemplatesRead> localVarResponse = await TemplatesGetAsyncWithHttpInfo(cursor);
             return localVarResponse.Data;
        ...
        /// <param name="cursor">A cursor value used to retrieve a specific page from a paginated result set. (optional)</param>
        /// <returns>Task of ApiResponse (TemplatesRead)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TemplatesRead>> TemplatesGetAsyncWithHttpInfo (string cursor = null)
        {
        ...
        /// <param name="targetLanguage">The type of templating language to compile as. Should only be used for visual templates.</param>
        /// <returns>TemplateRead</returns>
        public TemplateRead TemplatesTemplateIdGet (string templateId, string targetLanguage)
        {
             ApiResponse<TemplateRead> localVarResponse = TemplatesTemplateIdGetWithHttpInfo(templateId, targetLanguage);
             return localVarResponse.Data;
        }
        ...
        /// <param name="targetLanguage">The type of templating language to compile as. Should only be used for visual templates.</param>
        /// <returns>ApiResponse of TemplateRead</returns>
        public ApiResponse< TemplateRead > TemplatesTemplateIdGetWithHttpInfo (string templateId, string targetLanguage)
        {
            ...
            if (targetLanguage == null)
                throw new ApiException(400, "Missing required parameter 'targetLanguage' when calling TemplatesApi->TemplatesTemplateIdGet");
        ...
        /// <param name="targetLanguage">The type of templating language to compile as. Should only be used for visual templates.</param>
        /// <returns>Task of TemplateRead</returns>
        public async System.Threading.Tasks.Task<TemplateRead> TemplatesTemplateIdGetAsync (string templateId, string targetLanguage)
        {
             ApiResponse<TemplateRead> localVarResponse = await TemplatesTemplateIdGetAsyncWithHttpInfo(templateId, targetLanguage);
             return localVarResponse.Data;
        ...
        /// <param name="targetLanguage">The type of templating language to compile as. Should only be used for visual templates.</param>
        /// <returns>Task of ApiResponse (TemplateRead)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TemplateRead>> TemplatesTemplateIdGetAsyncWithHttpInfo (string templateId, string targetLanguage)
        {
            // verify the required parameter 'templateId' is set
            if (templateId == null)
                throw new ApiException(400, "Missing required parameter 'templateId' when calling TemplatesApi->TemplatesTemplateIdGet");
