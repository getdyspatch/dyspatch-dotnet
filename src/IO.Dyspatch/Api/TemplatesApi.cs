...
namespace IO.Dyspatch.Api
{
    ...
    public interface ITemplatesApi : IApiAccessor
    {
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        ...
        ApiResponse<TemplatesRead> TemplatesGetWithHttpInfo (string cursor = null, string accept = null);
        /// <summary>
        /// Get Template by ID
        /// </summary>
        /// <remarks>
        ...
        /// <param name="targetLanguage">The type of templating language to compile as. Should only be used for visual templates. (optional)</param>
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        ...
        ApiResponse<TemplateRead> TemplatesTemplateIdGetWithHttpInfo (string templateId, string targetLanguage = null, string accept = null);
        ...
        System.Threading.Tasks.Task<TemplatesRead> TemplatesGetAsync (string cursor = null, string accept = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<TemplatesRead>> TemplatesGetAsyncWithHttpInfo (string cursor = null, string accept = null);
        /// <summary>
        /// Get Template by ID
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<TemplateRead> TemplatesTemplateIdGetAsync (string templateId, string targetLanguage = null, string accept = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<TemplateRead>> TemplatesTemplateIdGetAsyncWithHttpInfo (string templateId, string targetLanguage = null, string accept = null);
    ...
    public partial class TemplatesApi : ITemplatesApi
    {
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>TemplatesRead</returns>
        public TemplatesRead TemplatesGet (string cursor = null, string accept = null)
        {
             ApiResponse<TemplatesRead> localVarResponse = TemplatesGetWithHttpInfo(cursor, accept);
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>ApiResponse of TemplatesRead</returns>
        public ApiResponse< TemplatesRead > TemplatesGetWithHttpInfo (string cursor = null, string accept = null)
        {
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>Task of TemplatesRead</returns>
        public async System.Threading.Tasks.Task<TemplatesRead> TemplatesGetAsync (string cursor = null, string accept = null)
        {
             ApiResponse<TemplatesRead> localVarResponse = await TemplatesGetAsyncWithHttpInfo(cursor, accept);
             return localVarResponse.Data;
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>Task of ApiResponse (TemplatesRead)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TemplatesRead>> TemplatesGetAsyncWithHttpInfo (string cursor = null, string accept = null)
        {
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>TemplateRead</returns>
        public TemplateRead TemplatesTemplateIdGet (string templateId, string targetLanguage = null, string accept = null)
        {
             ApiResponse<TemplateRead> localVarResponse = TemplatesTemplateIdGetWithHttpInfo(templateId, targetLanguage, accept);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>ApiResponse of TemplateRead</returns>
        public ApiResponse< TemplateRead > TemplatesTemplateIdGetWithHttpInfo (string templateId, string targetLanguage = null, string accept = null)
        {
            // verify the required parameter 'templateId' is set
            if (templateId == null)
                throw new ApiException(400, "Missing required parameter 'templateId' when calling TemplatesApi->TemplatesTemplateIdGet");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("TemplatesTemplateIdGet", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>Task of TemplateRead</returns>
        public async System.Threading.Tasks.Task<TemplateRead> TemplatesTemplateIdGetAsync (string templateId, string targetLanguage = null, string accept = null)
        {
             ApiResponse<TemplateRead> localVarResponse = await TemplatesTemplateIdGetAsyncWithHttpInfo(templateId, targetLanguage, accept);
             return localVarResponse.Data;
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>Task of ApiResponse (TemplateRead)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TemplateRead>> TemplatesTemplateIdGetAsyncWithHttpInfo (string templateId, string targetLanguage = null, string accept = null)
        {
            // verify the required parameter 'templateId' is set
            if (templateId == null)
                throw new ApiException(400, "Missing required parameter 'templateId' when calling TemplatesApi->TemplatesTemplateIdGet");
