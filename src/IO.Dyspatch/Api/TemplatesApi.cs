...
namespace IO.Dyspatch.Api
{
    ...
    public interface ITemplatesApi : IApiAccessor
    {
        ...
        ApiResponse<TemplatesRead> TemplatesGetWithHttpInfo (string accept, string cursor = null);
        /// <summary>
        /// Get Template by ID
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<TemplateRead> TemplatesTemplateIdGetWithHttpInfo (string templateId, string accept);
        ...
        System.Threading.Tasks.Task<TemplatesRead> TemplatesGetAsync (string accept, string cursor = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<TemplatesRead>> TemplatesGetAsyncWithHttpInfo (string accept, string cursor = null);
        /// <summary>
        /// Get Template by ID
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<TemplateRead> TemplatesTemplateIdGetAsync (string templateId, string accept);
        ...
        System.Threading.Tasks.Task<ApiResponse<TemplateRead>> TemplatesTemplateIdGetAsyncWithHttpInfo (string templateId, string accept);
    ...
    public partial class TemplatesApi : ITemplatesApi
    {
        ...
        /// <param name="cursor">A cursor value used to retrieve a specific page from a paginated result set. (optional)</param>
        /// <returns>TemplatesRead</returns>
        public TemplatesRead TemplatesGet (string accept, string cursor = null)
        {
             ApiResponse<TemplatesRead> localVarResponse = TemplatesGetWithHttpInfo(accept, cursor);
        ...
        /// <param name="cursor">A cursor value used to retrieve a specific page from a paginated result set. (optional)</param>
        /// <returns>ApiResponse of TemplatesRead</returns>
        public ApiResponse< TemplatesRead > TemplatesGetWithHttpInfo (string accept, string cursor = null)
        {
            // verify the required parameter 'accept' is set
            if (accept == null)
                throw new ApiException(400, "Missing required parameter 'accept' when calling TemplatesApi->TemplatesGet");
        ...
        /// <param name="cursor">A cursor value used to retrieve a specific page from a paginated result set. (optional)</param>
        /// <returns>Task of TemplatesRead</returns>
        public async System.Threading.Tasks.Task<TemplatesRead> TemplatesGetAsync (string accept, string cursor = null)
        {
             ApiResponse<TemplatesRead> localVarResponse = await TemplatesGetAsyncWithHttpInfo(accept, cursor);
             return localVarResponse.Data;
        ...
        /// <param name="cursor">A cursor value used to retrieve a specific page from a paginated result set. (optional)</param>
        /// <returns>Task of ApiResponse (TemplatesRead)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TemplatesRead>> TemplatesGetAsyncWithHttpInfo (string accept, string cursor = null)
        {
            // verify the required parameter 'accept' is set
            if (accept == null)
                throw new ApiException(400, "Missing required parameter 'accept' when calling TemplatesApi->TemplatesGet");
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2018.08\&quot;, set the value to \&quot;application/vnd.dyspatch.2018.08+json\&quot;</param>
        /// <returns>TemplateRead</returns>
        public TemplateRead TemplatesTemplateIdGet (string templateId, string accept)
        {
             ApiResponse<TemplateRead> localVarResponse = TemplatesTemplateIdGetWithHttpInfo(templateId, accept);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2018.08\&quot;, set the value to \&quot;application/vnd.dyspatch.2018.08+json\&quot;</param>
        /// <returns>ApiResponse of TemplateRead</returns>
        public ApiResponse< TemplateRead > TemplatesTemplateIdGetWithHttpInfo (string templateId, string accept)
        {
            ...
            // verify the required parameter 'accept' is set
            if (accept == null)
                throw new ApiException(400, "Missing required parameter 'accept' when calling TemplatesApi->TemplatesTemplateIdGet");
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2018.08\&quot;, set the value to \&quot;application/vnd.dyspatch.2018.08+json\&quot;</param>
        /// <returns>Task of TemplateRead</returns>
        public async System.Threading.Tasks.Task<TemplateRead> TemplatesTemplateIdGetAsync (string templateId, string accept)
        {
             ApiResponse<TemplateRead> localVarResponse = await TemplatesTemplateIdGetAsyncWithHttpInfo(templateId, accept);
             return localVarResponse.Data;
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2018.08\&quot;, set the value to \&quot;application/vnd.dyspatch.2018.08+json\&quot;</param>
        /// <returns>Task of ApiResponse (TemplateRead)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TemplateRead>> TemplatesTemplateIdGetAsyncWithHttpInfo (string templateId, string accept)
        {
            // verify the required parameter 'templateId' is set
            if (templateId == null)
                throw new ApiException(400, "Missing required parameter 'templateId' when calling TemplatesApi->TemplatesTemplateIdGet");
