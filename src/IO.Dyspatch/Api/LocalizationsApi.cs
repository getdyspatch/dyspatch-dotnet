...
namespace IO.Dyspatch.Api
{
    ...
    public interface ILocalizationsApi : IApiAccessor
    {
        ...
        ApiResponse<LocalizationRead> LocalizationsLocalizationIdGetWithHttpInfo (string localizationId, string targetLanguage = null, string accept = null);
        ...
        System.Threading.Tasks.Task<LocalizationRead> LocalizationsLocalizationIdGetAsync (string localizationId, string targetLanguage = null, string accept = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<LocalizationRead>> LocalizationsLocalizationIdGetAsyncWithHttpInfo (string localizationId, string targetLanguage = null, string accept = null);
    ...
    public partial class LocalizationsApi : ILocalizationsApi
    {
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>LocalizationRead</returns>
        public LocalizationRead LocalizationsLocalizationIdGet (string localizationId, string targetLanguage = null, string accept = null)
        {
             ApiResponse<LocalizationRead> localVarResponse = LocalizationsLocalizationIdGetWithHttpInfo(localizationId, targetLanguage, accept);
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>ApiResponse of LocalizationRead</returns>
        public ApiResponse< LocalizationRead > LocalizationsLocalizationIdGetWithHttpInfo (string localizationId, string targetLanguage = null, string accept = null)
        {
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>Task of LocalizationRead</returns>
        public async System.Threading.Tasks.Task<LocalizationRead> LocalizationsLocalizationIdGetAsync (string localizationId, string targetLanguage = null, string accept = null)
        {
             ApiResponse<LocalizationRead> localVarResponse = await LocalizationsLocalizationIdGetAsyncWithHttpInfo(localizationId, targetLanguage, accept);
             return localVarResponse.Data;
        ...
        /// <param name="accept">A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot; (optional)</param>
        /// <returns>Task of ApiResponse (LocalizationRead)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LocalizationRead>> LocalizationsLocalizationIdGetAsyncWithHttpInfo (string localizationId, string targetLanguage = null, string accept = null)
        {
            // verify the required parameter 'localizationId' is set
            if (localizationId == null)
                throw new ApiException(400, "Missing required parameter 'localizationId' when calling LocalizationsApi->LocalizationsLocalizationIdGet");
