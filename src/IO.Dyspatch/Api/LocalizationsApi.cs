...
namespace IO.Dyspatch.Api
{
    ...
    public interface ILocalizationsApi : IApiAccessor
    {
        ...
        ApiResponse<LocalizationRead> LocalizationsLocalizationIdGetWithHttpInfo (string localizationId, string targetLanguage);
        ...
        System.Threading.Tasks.Task<LocalizationRead> LocalizationsLocalizationIdGetAsync (string localizationId, string targetLanguage);
        ...
        System.Threading.Tasks.Task<ApiResponse<LocalizationRead>> LocalizationsLocalizationIdGetAsyncWithHttpInfo (string localizationId, string targetLanguage);
    ...
    public partial class LocalizationsApi : ILocalizationsApi
    {
        ...
        /// <param name="targetLanguage">The type of templating language to compile as. Should only be used for visual templates.</param>
        /// <returns>LocalizationRead</returns>
        public LocalizationRead LocalizationsLocalizationIdGet (string localizationId, string targetLanguage)
        {
             ApiResponse<LocalizationRead> localVarResponse = LocalizationsLocalizationIdGetWithHttpInfo(localizationId, targetLanguage);
        ...
        /// <param name="targetLanguage">The type of templating language to compile as. Should only be used for visual templates.</param>
        /// <returns>ApiResponse of LocalizationRead</returns>
        public ApiResponse< LocalizationRead > LocalizationsLocalizationIdGetWithHttpInfo (string localizationId, string targetLanguage)
        {
            ...
            if (targetLanguage == null)
                throw new ApiException(400, "Missing required parameter 'targetLanguage' when calling LocalizationsApi->LocalizationsLocalizationIdGet");
        ...
        /// <param name="targetLanguage">The type of templating language to compile as. Should only be used for visual templates.</param>
        /// <returns>Task of LocalizationRead</returns>
        public async System.Threading.Tasks.Task<LocalizationRead> LocalizationsLocalizationIdGetAsync (string localizationId, string targetLanguage)
        {
             ApiResponse<LocalizationRead> localVarResponse = await LocalizationsLocalizationIdGetAsyncWithHttpInfo(localizationId, targetLanguage);
             return localVarResponse.Data;
        ...
        /// <param name="targetLanguage">The type of templating language to compile as. Should only be used for visual templates.</param>
        /// <returns>Task of ApiResponse (LocalizationRead)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LocalizationRead>> LocalizationsLocalizationIdGetAsyncWithHttpInfo (string localizationId, string targetLanguage)
        {
            // verify the required parameter 'localizationId' is set
            if (localizationId == null)
                throw new ApiException(400, "Missing required parameter 'localizationId' when calling LocalizationsApi->LocalizationsLocalizationIdGet");
